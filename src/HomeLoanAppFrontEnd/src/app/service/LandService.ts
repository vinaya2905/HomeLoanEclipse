  ...
  export class LandService{
    ...
    constructor(http:HttpClient){
     ...
     fetchLoanApplications(){
       this.applications=[];
       this.http.get<LoanApplication[]>("http://localhost:8086/landverification/findall").subscribe(
         data=>{
           this.convert(data);
         }
       );
     ...
     read(id:any): Observable<any> {
      ...
      return this.http.get(`http://localhost:8086/landverification/find/`+id);
    }
    updateLoanApplication(id:any,value:any):Observable<any>{
      return this.http.put(`http://localhost:8086/landverification/update/`+id,value);
    }
  }
